...
st.set_page_config(
    page_title="Disaster-Tweets-Dector", layout="wide", page_icon="random"
)
# Titre
...
if option == "mon propre tweet":
    ...
    if tweet:
        ...
        raw_tweet_tab, preprocessed_tweet_tab, predictions_tab = st.tabs(
            tabs=["tweet brut", "tweet traité", "prédiction"]
        )
        with raw_tweet_tab:
